...
# Define div elements for locator
SELECTORS = {
    "login_email": "#email",
    ...
    "community_card_username": ".community-member-card__username",
    "meta_text_wrapper": "div[data-sentry-element='MetaTextWrapper']",  # community's name and link
    "replies_tab": "a[data-testid='profile-reply']",
    "community_metadata": "div[data-sentry-component='Details']",
